    ...
    <footer className="border-t border-cream-300 dark:border-espresso-700 bg-cream-50 dark:bg-espresso-900">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 xl:px-32 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-10 mb-14">
          ...
          {/* Navigation */}
          <div>
            <h4 className="font-mono text-xs tracking-widest uppercase text-sand-500 dark:text-sand-500 mb-4">
              Navigation
            </h4>
              ...
              {socials.map((s) => {
                ...
                return (
                  <a
                    ...
                    className="flex items-center gap-2 font-body text-sm text-espresso-700 dark:text-cream-300 hover:text-espresso-900 dark:hover:text-cream-100 transition-colors"
                  >
